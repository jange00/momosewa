const SignupPromo = () => {
  return (
    <div className="hidden lg:flex relative bg-gradient-to-br from-deep-maroon via-[#7a2533] to-[#6a1f2d] p-5 xl:p-6 flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-white">
        ...
        {/* Welcome Section */}
        <div className="mb-5">
          <h1 className="text-5xl xl:text-6xl font-black mb-2 leading-tight">
            Join Us Today
          </h1>
        ...
        {/* Feature Box */}
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-golden-amber/20 mb-5">

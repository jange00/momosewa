...
import { FiMail, FiLock, FiPhone, FiUser, FiMapPin, FiShoppingBag, FiFileText } from "react-icons/fi";
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="bg-golden-amber/10 border border-golden-amber/20 rounded-xl p-3">
              <p className="text-xs text-charcoal-grey/70 leading-relaxed">
                <span className="font-semibold text-charcoal-grey">Note:</span> Your vendor account will be reviewed by our admin team. You'll receive a confirmation email once approved.
              </p>
            </div>
